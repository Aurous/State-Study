...
namespace States
{
  ...
  {
    public string[] statenames = new string[50]{ "Alabama", "Alaska", "Arizona", "Arkansas", "California", "Colorado", "Commecticut", "Delaware", "Florida", "Georgia", "Hawaii", "Idaho", "Illinos", "Indiana", "Iowa", "Kansas", "Kentucky", "Louisiana", "Maine", "Maryland", "Massachusetts", "Michigan", "Minnesota", "Mississipi", "Missouri", "Montana", "Nebraska", "Nevada", "New Hampshire", "New Jersey", "New Mexico", "New York", "North Carolina", "North Dakota", "Ohio", "Oklahoma", "Oregon", "Pennsylvania", "Rhode Island", "South Carolina", "South Dakota", "Tennessee", "Texas", "Utah", "Vermont", "Virginia", "Washington", "West Virginia", "Wisconsin", "Wyoming" };
    public string[] capitolnames = new string[50]{ "Montgomery", "Juneau", "Phoenix", "Little Rock", "Sacramento", "Denver", "Hartford", "Dover", "Tallahassee", "Atlanta", "Honolulu", "Boise", "Springfield", "Indianapolis", "Des Moines", "Topeka", "Frankfort", "Botan Rouge", "Augusta", "Annapolis", "Boston", "Lancing", "Saint Paul", "Jackson", "Jefferson City", "Helena", "Lincoln", "Carson City", "Concord", "Trenton", "Santa Fe", "Albany", "Raleigh", "Bismarck", "Columbus", "Oklahoma City", "Salem", "Harrisburg", "Providence", "Columbia", "Pierre", "Nashville", "Austin", "Salt Lake City", "Montpelier", "Richmond", "Olympia", "Charleston", "Madison", "Cheyenne" };
    ...
    {
      this.rndstate();
      this.label1.Text = this.capitolnames[this.s.number] + " is the capitol of?";
      this.textBox1.Text = "";
    }
    ...
    public void check(string checking)
    {
      ...
      else
      {
        if (!(checking != ""))
          return;
        if (checking == this.statenames[this.s.number])
        {
    ...
    private void InitializeComponent()
    {
      ...
      this.SuspendLayout();
      this.button1.Location = new Point(15, 51);
      ...
      this.button2.Location = new Point(86, 51);
      ...
      this.button3.Location = new Point(86, 80);
      ...
      this.button4.Location = new Point(15, 80);
      ...
      this.ClientSize = new Size(168, 117);
